...
def update(val=1):
   frequence=slider.val              # Affectation de la valeur du curseur à la variable "frequence"
   sinus=sin(temps*2*pi*frequence)   # Calcul des ordonnées
   courbe.set_ydata(sinus)           # Affectation des nouvelles ordonnées à la courbe
...
slider = Slider(sliderDessin, 'Fréquence', 1, 10, 1 ,valfmt='%1.1f Hz')
